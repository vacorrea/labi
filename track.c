...
void prepareNewTrack() {
    ...
    system("clear");
    receberString("informe o endereco da pista",pista.endereco,NAME_SIZE);
    receberString("informe a UF da pista",pista.UF, 2);
    ...
    receberString("informe o codigo do aviao que obteve o recorde",pista.codigoAviaoFK, PLANE_CODE_SIZE);
